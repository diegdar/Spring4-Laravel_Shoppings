...
class ProductPurchaseController extends Controller
{
    ...
    {
        // Reemplaza las comas de los decimales por puntos para que lo acepte la BBDD
        ...
        if ($existingPurchase) {
            ...
            $import = $request->quantity * $unitPrice; // Utiliza el valor formateado de unit_price
            $productPurchase = ProductPurchase::create([
                'purchase_id' => $request->purchase_id,
                'product_id' => $request->product_id,
                'quantity' => $request->quantity,
                'unit_price' => $unitPrice, // Utiliza el valor formateado de unit_price
                'import' => $import,
            ]);
