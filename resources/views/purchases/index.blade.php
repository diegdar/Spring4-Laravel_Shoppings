                ...
                <form action="{{ route('purchases.store') }}" method="POST">
                    ...
                    <td>
                        <div class='px-4 py-2 border border-blue-200 rounded flex flex-col'>
                            <input type="text" class="h-9" name="purchase_date" style="text-align: center;" >
                            @error('purchase_date')
                                {{-- note 2 --}}
                    ...
                    <td>
                        <div class='px-4 py-2 border border-blue-200 rounded flex flex-col'>
                            <input type="number" class="h-9" name="quantity" min="1" max="1000" style="text-align: center;" >
                            @error('quantity')
                                {{-- note 2 --}}
                                <span class="textValidation">*{{ $message }}</span>
                            @enderror
                    ...
                    <td>
                        <div class='px-4 py-2 border border-blue-200 rounded flex flex-col'>
                            <input type="text" class="h-9" name="amount" style="text-align: center; width: 100px; max-width: 150px;">
                            @error('amount')
                                {{-- note 2 --}}
                                <span class="textValidation">*{{ $message }}</span>
                            @enderror
